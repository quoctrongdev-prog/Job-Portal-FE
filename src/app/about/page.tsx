        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold">
                {/* tracking-tight chu dinh lai sat hon HireHeaven */}
              Our Mission At <span className="text-blue-500">Hire</span>
              <span className="text-red-500">Heaven</span>
            </h1>
            <p className="text-lg md:text-xl leading-relaxed opacity-90 max-w-3xl mx-auto">
              At HireHaven, we&apos;re dedicated to revolutionizing the job
