  ...
  return (
    <section className='relative overflow-hidden bg-secondary'>
        <div className='absolute inset-0 opacity-5'>
            <div className='absolute top-20 left-10 w-72 h-72 bg-blue-500 rounded-full
            blur-3xl'></div>
            <div className='absolute bottom-20 right-10 w-96 h-96 bg-blue-500 rounded-full
            blur-3xl'></div>
        </div>
            ...
            md:gap-16">
                ...
                text-center md:text-left space-y-6'>
                    ...
                    rounded-full border bg-background/50 backdrop-blur-sm'>
                        ...
                        <span className='text-sm font-medium'>#1 Job Platform in VietNam</span>
                    </div>

                    {/* main heading  */}
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold
                    leading-tight">
                        Find Your Dream Job at <span className='inline-block text-blue-500'>Hire</span>
                    ...
                    <p className="text-lg md:text-xl leading-relaxed opacity-80 max-w-2xl">
                        ...
                        you covered with powerfull tools and seamless experience. 
                    </p>
                ...
                <div className="flex-1 relative">
                    <div className="relative group">
                        <div className="absolute -inset-4 bg-blue-400
                        opacity-20 blur-xl group-hover:opacity-30 transition-opacity"></div>

                        <div className="relative rounded-2xl overflow-hidden shadow-2xl
                        border-4 border-background">
                            <img src="/hero.png" className='object-cover object-center w-full
                            h-full transform transition-transform duration-500 
                            group-hover:scale-105' alt='hero section'/>
                        </div>
                    </div>
                </div>
            </div>
