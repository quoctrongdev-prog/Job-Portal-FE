...
const Navbar = () => {
  ...
  return (
    <nav className='z-50 sticky top-0 bg-background/80 border-b 
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='flex items-center'>
                    <Link href={'/'} className='flex items-center gap-1 group'>
                        <div className='text-2xl font-bold tracking-tight'>
                            <span className="bg-linear-to-r from bg-blue-600
                            to-blue-800 bg-clip-text text-transparent">Hire</span>
            ...
            <div className='hidden md:flex items-center gap-3'>
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            ...
                            transition-opacity'>
                                ...
                                ring-offset-background ring-blue-500/20 cursor-pointer
                        ...
                        <PopoverContent className='w-56 p-2' align="end">
                            ...
                            <Link href={'/account'}>
                                <Button className='w-full justify-start gap-2 cursor-pointer' variant={'ghost'}>
                                    <User size={16} /> My Profile
                                </Button>
                            </Link>

                            <Button className="w-full justify-start gap-2 mt-1 cursor-pointer" variant={'ghost'} onClick={logoutHandler}>
                ...
                <div className='md:hidden flex items-center gap-3'>
                    <ModeToggle />
                    <button onClick={toggleMenu} className='p-2 rounded-lg hover:bg-accent
                    transition-colors cursor-pointer' aria-label="Toggle menu">
