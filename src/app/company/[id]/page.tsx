...
const CompanyPage = () => {
  ...
  const addJobHandler = async () => {
    ...
    try {
      ...
      fetchCompany();
      clearInput();
      //trigger click vào element đang giữ ref
      //Code gọi .click() → element có ref bị click
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <Card className="overflow-hidden shadow-lg border-2 mb-8">
            ...
            <div className="px-8 pb-8">
              ...
              >
                <div
                  className="w-32 h-32 rounded-2xl border-4 border-background
                        overflow-hidden shadow-xl bg-background shrink-0"
                >
                  <img
                    src={company.logo}
                    alt=""
                    ...
                    <div className="space-y-5 py-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          {/* onValueChange: Dùng khi component trả về value trực tiếp
                            không phải event */}
                ...
                {company.jobs && company.jobs.length > 0 ? (
                  ...
                  <>
                    <div className="text-center py-12 ">
                      ...
                      h-16 rounded-full bg-gray-100 dark:bg-gray-800 mb-4"
                      >
