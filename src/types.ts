...
//setUser, setLoading, setIsAuth no la set cua useState ma hoat dong
//bang cach truyen du lieu qua bang context (no la useState lun nh ma hd bang cach nay)
//context: giup truyen du lieu cho ca App ma ko can truyen qua props
//cua tung components
export interface AppContextType {
  ...
  //la kieu ham promise (async) bat dong bo, void ko tra ve du lieu gi
...
//Boc App lai va cung cap du lieu cho ca App (check type)
//Exp: <AppProvider>
//      <App />
//     </AppProvider>
