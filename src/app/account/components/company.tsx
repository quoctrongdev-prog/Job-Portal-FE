...
const Company = () => {
  ...
  //gia lap click vao button an de mo dialog
  const openDialog = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-blue-500 p-6 border-b">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              <div
                className="h-10 w-10 rounded-lg bg-blue-100
            ...
            {companies.length < 3 && (
              //goi ham openDialog khi click vao button Add Company
            ...
            {companies.length > 0 ? (
              <div className="grid gap-4">
                {companies.map((c) => (
                  ...
                  border-2 hover:borde-blue-500 transition-all bg-background"
                  >
                    <div
              ...
              <>
                ...
                rounded-full bg-gray-100 dark:br-gray-800 mb-4"
                  >
                    <Building2
                      size={32}
                      className="opacity-40 dark:text-gray-700"
                    />
                  </div>
      ...
      <Dialog>
        <DialogTrigger asChild>
          {/* Khi click Add Company thi button nay se duoc click
          va DialogTrigger se kich hoat va ma ra Dialog */}
